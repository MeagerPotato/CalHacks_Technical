...
- A `dl` of `div[data-identity-field=name|email|birthdate|countryOfResidence|cityOfResidence|affiliation|links]` entries, in About you order. The birthdate is a formatted date, the country shows its name, and links open in a new tab.
