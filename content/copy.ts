...
export const COPY = {
  ...
  schedule: {
    timeline: {
      ...
      toBeAnnounced: "Awaiting coordinates",
    },
    countdown: {
      title: "Mission clock",
      ...
      launch: {
        ...
        caption: "Application hatch closes",
        completeText: "The application hatch is closed.",
      },
      landing: {
        title: "Time to landing",
        caption: "Cal Hacks touches down",
        completeText: "Cal Hacks has landed.",
      },
      units: {
        days: "Days",
        hours: "Hours",
